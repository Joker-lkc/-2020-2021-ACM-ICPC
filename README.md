...
队内 rating 分为二部分, **在线比赛 rating, 刷题 rating.** 会定期统计rating排名.
 ...
 - codeforce rating 计算方法: 最近三场cf rating值最高分 * 0.8 + 有效场次 * 2（参加场数未达到6场或rating低于800则不计分）
 - atcoder rating 计算方法：最近三场rating值最高分 * 1
 - Nowcode rating 计算方法: 最近三场cf rating值最高分 * 0.5 + 有效场次 * 2（参加场数未达到6场或rating低于100则不计分）
